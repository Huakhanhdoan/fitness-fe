import 'package:fitness/social/add_status_text.dart';
...
// class AddStatusImage extends StatefulWidget {
//   const AddStatusImage({super.key});
//
//   @override
//   _AddStatusImageState createState() => _AddStatusImageState();
// }
//
// class _AddStatusImageState extends State<AddStatusImage> {
...
class AddStatusImage extends StatefulWidget {
  const AddStatusImage({Key? key}) : super(key: key);
...
class _AddStatusImageState extends State<AddStatusImage> {
  ...
  void navigateToAddStatusText() {
    if (_currentSelectedPic != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AddStatusText(file: _currentSelectedPic),
        ),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: navigateToAddStatusText,
            icon: const Icon(
              size: 30,
              Icons.arrow_forward,
              color: Colors.black,
